...
import Checkbox from "../../Checkbox"; // plasmic-import: z_nsS4yGZ-iL/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: g783eUrtjnAk/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__lIyiy)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__qXt2I)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__uRpU)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__nnPy5)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
