...
import TextInput from "../../TextInput"; // plasmic-import: qgQNzt9ri8AV/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: nOyyGaPgUQ7h/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: q-Vnb8Rku23h/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__e15Wz, {
          [sty.freeBoxiconEnd__e15WZh4Llx]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__e15WZfErp6]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__e15WzFwtTn]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__uljR, {
            [sty.freeBoxiconStart__uljRFErp6]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__uljRFwtTn]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__spHpj)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___8L05Z, {
            [sty.freeBoxiconEnd___8L05Zh4Llx]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___8L05ZfErp6]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__b3U8C)}
                role={"img"}
              />
            ),
