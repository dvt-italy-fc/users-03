...
export function BasketStarIcon(props) {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M17 10l-2-6m-8 6l2-6m1.5 16H7.244a3 3 0 01-2.965-2.544l-1.255-7.152A2 2 0 015.001 8H19a2 2 0 011.977 2.304l-.133.757m-7.248 1.733a2 2 0 00-3.377 2.116"
        }
        stroke={"currentColor"}
        strokeWidth={"2"}
        strokeLinecap={"round"}
