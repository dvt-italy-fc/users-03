...
export function WashTemperature2Icon(props) {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M3 6l1.721 10.329A2 2 0 006.694 18h10.612a2 2 0 001.973-1.671L21 6m-7 7h.01M10 13h.01"
        }
        stroke={"currentColor"}
        strokeWidth={"2"}
        strokeLinecap={"round"}
...
export default WashTemperature2Icon;
/* prettier-ignore-end */
