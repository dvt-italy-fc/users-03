...
export function WorldStarIcon(props) {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M21 12a9 9 0 10-9.968 8.948M3.6 9h16.8M3.6 15H10m1.5-12a17 17 0 00-1.886 13.802M12.5 3a16.982 16.982 0 012.549 8.01"
        }
        stroke={"currentColor"}
        strokeWidth={"2"}
        strokeLinecap={"round"}
