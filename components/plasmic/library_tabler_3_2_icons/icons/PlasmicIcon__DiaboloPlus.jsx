...
export function DiaboloPlusIcon(props) {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M4 6v.143a1 1 0 00.048.307L6 12l-1.964 5.67a1 1 0 00-.036.265V18c0 1.657 3.582 3 8 3 .17 0 .34-.002.508-.006M18 12l1.952-5.55A1 1 0 0020 6.143V6"
        }
        stroke={"currentColor"}
        strokeWidth={"2"}
        strokeLinecap={"round"}
      ...
      <path
        d={"M6 12c0 1.105 2.686 2 6 2s6-.895 6-2m-2 7h6m-3-3v6"}
        stroke={"currentColor"}
        strokeWidth={"2"}
        strokeLinecap={"round"}
        strokeLinejoin={"round"}
