...
export function DeviceIpadHorizontalStarIcon(props) {
  ...
  return (
    ...
    >
      ...
      <path
        d={"M10.5 20H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v5.5M9 17h1"}
        stroke={"currentColor"}
        strokeWidth={"2"}
        strokeLinecap={"round"}
...
export default DeviceIpadHorizontalStarIcon;
/* prettier-ignore-end */
