...
export function CameraStarIcon(props) {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M10.5 20H5a2 2 0 01-2-2V9a2 2 0 012-2h1a2 2 0 002-2 1 1 0 011-1h6a1 1 0 011 1 2 2 0 002 2h1a2 2 0 012 2v2.5m-6.431-.05a3 3 0 10-4.518 3.83"
        }
        stroke={"currentColor"}
        strokeWidth={"2"}
        strokeLinecap={"round"}
