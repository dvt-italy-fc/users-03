...
export function MapPinStarIcon(props) {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M15 11a3 3 0 10-3.908 2.86m-.033 7.39a1.999 1.999 0 01-.472-.35l-4.244-4.243a8 8 0 1113.646-6.079"
        }
        stroke={"currentColor"}
        strokeWidth={"2"}
        strokeLinecap={"round"}
